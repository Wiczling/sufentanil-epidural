...
generated quantities{
  ...
  array[nTheta] real<lower=0> thetaPred;
    ...
    thetaPred[1] = thetaHat[1] * fr[1] * etaPredM[j, 1] ; // CL
    thetaPred[2] = thetaHat[2] * fr[2] * etaPredM[j, 2] ; // Q
    thetaPred[3] = thetaHat[3] * fr[3] * etaPredM[j, 3] ; // V1
    thetaPred[4] = thetaHat[4] * fr[4] * etaPredM[j, 4] ; // V2
