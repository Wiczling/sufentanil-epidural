...
modx  <- read_model(here::here(model_dir, "4"))
mod_to_plot1 <- read_fit_model(modx)
modx  <- read_model(here::here(model_dir, "4a"))
mod_to_plot2 <- read_fit_model(modx)
